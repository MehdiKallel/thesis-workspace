...
class MyWorkload extends WorkloadModuleBase {
	...
	async submitTransaction(){
		...
		const myArgs2 = {
			...
			contractArguments: [String(drug.name), String(drugsToOrder), String(companiesData[0].companyMat), String(companiesData[0].companyMat), String(orderReference), "1-PDC"],
		};
