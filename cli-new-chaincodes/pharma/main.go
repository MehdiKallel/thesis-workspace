...
// pattern 1: price if public to anyone
...
// createPrivateOrder - checks that the requested quantity of the drug is available on the ledger and add the price (private data) to 1 or 2 private data collections
...
// checkPrivateOrderP2 - check that the agreed pice between the seller and the buyer is the same
